...
# nemám ponětí co v řádku year dělá [0].year ale asi to funguje
year = rrule(YEARLY,dtstart=now,bymonth=12,bymonthday=24,byweekday=6)[0].year

print(str(now)[:19])
for i in range(1, 6):
    print(easter.easter(i+int(str(now)[:4])))
print(year)
